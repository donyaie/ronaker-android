...
class DefaultContentRepository(val contentApi: ContentApi) : ContentRepository {


    override fun uploadImageWithoutProgress(
        token: String?,
        filePath: Uri
    ): Observable<Result<ContentImageResponceModel>> {
    ...
    override fun deleteImage(token: String?, suid: String): Observable<Result<FreeResponseModel>> {
    ...
    fun createMultipartBody(filePath: Uri): MultipartBody.Part {
